# Comparing `tmp/thunder-ase-0.2.2.tar.gz` & `tmp/thunder-ase-0.2.4.tar.gz`
...
## Comparing `thunder-ase-0.2.2.tar` & `thunder-ase-0.2.4.tar`
...
### Comparing `thunder-ase-0.2.2/PKG-INFO` & `thunder-ase-0.2.4/PKG-INFO`
...
### Comparing `thunder-ase-0.2.2/README.md` & `thunder-ase-0.2.4/README.md`
...
### Comparing `thunder-ase-0.2.2/tests/test_Si_lightning.py` & `thunder-ase-0.2.4/tests/test_Si_lightning.py`

 * *Files identical despite different names*

### Comparing `thunder-ase-0.2.2/thunder_ase/fireball.py` & `thunder-ase-0.2.4/thunder_ase/fireball.py`
...
### Comparing `thunder-ase-0.2.2/thunder_ase.egg-info/PKG-INFO` & `thunder-ase-0.2.4/thunder_ase.egg-info/PKG-INFO`
