# Comparing `tmp/nso-oc-2.59.0.tar.gz` & `tmp/nso-oc-2.60.0.tar.gz`
...
### Comparing `nso-oc-2.59.0/package_nso_to_oc/xe/xe_ospfv2.py` & `nso-oc-2.60.0/package_nso_to_oc/xe/xe_ospfv2.py`
