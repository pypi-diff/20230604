# Comparing `tmp/nso-oc-2.55.0.tar.gz` & `tmp/nso-oc-2.56.0.tar.gz`
...
### Comparing `nso-oc-2.55.0/package_nso_to_oc/xe/xe_ospfv2.py` & `nso-oc-2.56.0/package_nso_to_oc/xe/xe_ospfv2.py`
