# Comparing `tmp/nso-oc-2.57.0.tar.gz` & `tmp/nso-oc-2.58.0.tar.gz`
...
### Comparing `nso-oc-2.57.0/package_nso_to_oc/xe/xe_ospfv2.py` & `nso-oc-2.58.0/package_nso_to_oc/xe/xe_ospfv2.py`
